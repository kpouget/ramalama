...
class mBot():
    ...
    def doRGBLed(self, slot, red, green, blue):
        self.__writePackage(bytearray([0xff, 0x55, 0x09, 0x03, 0x02, 0x08, 0x07,
                                       slot,red,green,blue]))

    def doRGBLedOnBoard(self, slot, red, green, blue):
        self.doRGBLed(slot, red, green, blue)
